                    ...
                    <form className="space-y-4" onSubmit={handleSaveProfile}>
                        ...
                        <div className="flex flex-col items-start gap-3">
                            ...
                            text-gray-700 mb-1">
                                ...
                                onChange={(e) => setEditForm({...editForm, profile_picture:e.target
                                    .files[0]})}/>
                                    <div className="group/profile relative">
                                        <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture)
                                            : user.profile_picture} alt="" className="w-24 h-24 rounded-full object-cover
                                            mt-2"/>

                                            <div className="absolute hidden group-hover/profile:flex
                                            inset-0 bg-black/20 rounded-full items-center justify-center">
                                ...
                                onChange={(e) => setEditForm({...editForm, cover_photo:e.target.files[0]})}/>
                                    <div className="group/cover relative">
                                        <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo)
                                            ...
                                            <div className="absolute hidden group-hover/cover:flex inset-0
                        ...
                        <div>
                            ...
                            <input type="text" className="w-full p-3 border border-gray-200
                            rounded-lg" placeholder="Please enter a username" onChange={(e)=>
                        ...
                        <div>
                            ...
                            rounded-lg" placeholder="Enter about you" onChange={(e)=>
                        ...
                        <div className="flex justify-end space-x-3 pt-6">
                            ...
                            from-indigo-500 to-purple-600 rounded-lg hover:from-indigo-600 
