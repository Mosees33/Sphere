...
import { addMessages, fetchMessages, resetMessages } from '../feature/messages/messagesSlice';
        ...
        <div className='flex flex-col h-screen'>
            ...
            <div className='p-5 md:px-10 h-full overflow-y-scroll'>
                <div className='space-y-4 max-w-4xl mx-auto'>
                    {
                        [...messages].toSorted((a,b) => new Date(a.created_at) - 
                        new Date(b.created_at)).map((message, index)=> (
