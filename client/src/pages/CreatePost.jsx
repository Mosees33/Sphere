...
const CreatePost = () => {
    ...
    const handleSubmit = async () => {
        if(!images.length && !content){
            return toast.error('At least one image/text content is required')
        }setloading(true)
    ...
    return (
        <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
            <div className='max-w-6xl mx-auto p-6'>
                {/* title */}
                <div className='mb-8'>
                    <h1 className='text-3xl font-bold text-scale-900 mb-2'>Create post</h1>
                ...
                space-y-4'>
                    ...
                    {/* Images */}
                    {
                        images.length > 0 && <div className='flex flex-wrap gap-3 mt-4'>
                            {images.map((image, i) => (
                                <div key={i} className='relative group'>
                                    ...
                                    <div onClick={() => setImages(images.filter((_, index)=> index !== i))}
                                        ...
                                        inset-0 bg-black/40 rounded-md cursor-pointer'>
